...
@section('content')
    @include('sale.partials.header', ['title' => __('Edit Sale')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('sale.update', $sale) }}" autocomplete="off">
                            @csrf
                            @method('put')
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('products') ? ' has-danger' : '' }}">
                                    ...
                                    {{ Form::select('products[]', $products->pluck('name', 'id'), $sale->products()->pluck('id'), [ 'multiple' => 'multiple', 'class' => 'selectpicker form-control form-control-alternative', 'data-live-search' => 'true']) }}
                                ...
                                <div class="form-group{{ $errors->has('seller') ? ' has-danger' : '' }}">
                                    ...
                                    {{ Form::select('id_seller', $sellers->pluck('name', 'id'), $sale->seller()->pluck('id'), [ 'class' => 'selectpicker form-control form-control-alternative', 'data-live-search' => 'true']) }}
