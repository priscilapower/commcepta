...
@section('content')
    @include('product.partials.header', ['title' => __('Add Product')])
                        ...
                        <form method="post" action="{{ route('product.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="price" id="input-price"  min="0.01" step="0.01" class="form-control form-control-alternative{{ $errors->has('price') ? ' is-invalid' : '' }}" placeholder="{{ __('Price') }}" value="{{ old('price') }}" required autofocus>
